...
`ExUnit.CaptureLog` and `ExUnit.CaptureServer` were created by Plataformatec and
The Elixir Team. Austin Ziegler modified it to allow capturing from alternative
log formatters.
