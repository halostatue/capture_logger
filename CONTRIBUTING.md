...
Contribution to CaptureLogger is encouraged: bug reports, discussions, feature
...
CaptureLogger is governed under the
...
CaptureLogger contributions must be well understood by the submitter and that,
...
ExUnit.CaptureLog and ExUnit.CaptureServer were created by Plataformatec and The
Elixir Team. Austin Ziegler modified it to allow capturing with alternative log
formatters.
